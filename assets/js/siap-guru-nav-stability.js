...
(()=>{
  ...
  const loadPerangkatEnhancers=(onload)=>loadScript('assets/js/siap-guru-perangkat-rpm-bridge-v1.js?v=2','perangkatRpmBridgeV2',()=>loadScript('assets/js/siap-guru-perangkat-auto-v2.js?v=4','perangkatAutoV2',onload));
  const openProsem=()=>loadScript('assets/js/siap-guru-prosem-matrix-v4.js?v=10','prosemMatrixFinalV10',()=>{loadScript('assets/js/siap-guru-prosem-export-v4.js?v=12','prosemExportV12',()=>{if(typeof window.__openSiapGuruProsem==='function')window.__openSiapGuruProsem()})});
