...
(()=>{
  ...
  const openProsem=()=>loadScript('assets/js/siap-guru-prosem-matrix-v4.js?v=6','prosemMatrixFinalV6',()=>{if(typeof window.__openSiapGuruProsem==='function')window.__openSiapGuruProsem()});
