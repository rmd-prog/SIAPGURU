...
function loadRoomVisual(){let l=document.querySelector('link[data-sg-room-visual]');if(!l){l=document.createElement('link');l.rel='stylesheet';l.dataset.sgRoomVisual='1';document.head.appendChild(l)}l.href='assets/css/siap-guru-room-visual-v1.css?v=3'}
